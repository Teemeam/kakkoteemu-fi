      ...
      <div className='relative mx-auto w-11/12'>
        ...
        <div className='my-xl flex items-center justify-center'>
          {filtered_articles.length > 3 && numberOfCards < filtered_articles.length && (
            ...
            >
              <div className='absolute -z-10 h-1/2 w-9/12 bg-gradient-to-b from-gradient1-step1 to-gradient1-step2 opacity-0 blur-lg transition-opacity duration-200 group-hover:opacity-100' />
